   ...
   const embed1 = new EmbedBuilder()
       ...
       .addFields(
           ...
           },
           {
               name: '🏗️ CONSTRUCCIÓN',
               value: [
                   '**Zonas prohibidas** — Está completamente prohibida la edificación en:\n' +
                   '▪ Todo tipo de cuevas.\n' +
                   '▪ Zonas de spawn masivo de recursos (grandes montañas de metal, obsidiana o cristal).\n' +
                   '▪ Puntos de aparición de notas de explorador.\n' +
                   'Cualquier estructura que bloquee estos elementos será eliminada por la administración sin previo aviso.',
                   '',
...
// --- MENSAJE FIJO DE BIENVENIDA EN #bienvenida ---
